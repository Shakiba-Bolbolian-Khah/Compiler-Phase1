...
ifExp returns[Statement value] locals[int i,List<Expression> conds, List<Statement> stmts, Statement elze,List<Integer> lines, List<Integer> poses]
    :   {
        ...
        | ie = ifWithoutElse { $stmts.add($ie.value);}
...
ifWithoutElse returns[Statement value] locals[int i,List<Expression> conds, List<Statement> stmts, Statement elze,List<Integer> lines, List<Integer> poses]
    :   {
            $conds = new ArrayList<>();
            $stmts = new ArrayList<>();
            $lines = new ArrayList<>();
