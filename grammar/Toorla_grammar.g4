...
ifExp
    : IF RPARAN expression LPARAN ((ifBody) (elifStmt)* elseStmt? | ifWithoutElse| (completeIf) ((elifStmt)* elseStmt? ))
    ;

ifWithoutElse
    :   IF RPARAN expression LPARAN ((ifBody|ifExp) (elifStmt)* )
    ;
